...
class _DisapprovedViewState extends State<DisapprovedView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Disapproved Selfies'),
      ),
      body: Consumer<DisapprovedProvider>(
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  DataRowWidget(
                                    text: disapproved
                                        .disapprovedList[index].employeeId,
                                    width: 50.0,
                                    color: Colors.amber,
                                  ),
                                  DataRowWidget(
                                    text: disapproved.fullName(
                                        disapproved.disapprovedList[index]),
                                    width: 200.0,
                                    color: Colors.pink,
                                  ),
                                  DataRowWidget(
                                    text: disapproved
                                        .disapprovedList[index].logType,
                                    width: 80.0,
                                    color: Colors.teal,
                                  ),
                                  DataRowWidget(
                                    text: disapproved
                                        .disapprovedList[index].department,
                                    width: 100.0,
                                    color: Colors.teal,
                                  ),
                                  DataRowWidget(
                                    text:
                                        disapproved.disapprovedList[index].team,
                                    width: 100.0,
                                    color: Colors.teal,
                                  ),
                                  DataRowWidget(
                                    text: DateFormat('yyyy-MM-dd HH:mm').format(
                                        disapproved
                                            .disapprovedList[index].timeStamp),
                                    width: 150.0,
                                    color: Colors.blue,
                                  ),
                                  DataRowWidget(
                                    text: disapproved
                                        .disapprovedList[index].approvedBy,
                                    width: 150.0,
                                    color: Colors.purple,
                                  ),
                                  SizedBox(
