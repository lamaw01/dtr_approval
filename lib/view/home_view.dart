...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SelfiesProvider>(
              ...
              children: [
                ...
                if (MediaQuery.of(context).size.width > 600) ...[
                            ...
                            Container(
                              ...
                              child: TextButton(
                                onPressed: () async {
                                  ...
                                  await selfies
                                      .getSelfiesAll(department.dropdownValue);
                  ...
                  if (selfies.selfieList.isNotEmpty) ...[
                    ...
                    if (selfies.uiList.length < selfies.selfieList.length) ...[
                      SizedBox(
                        height: 50.0,
                        width: 180.0,
                        child: TextButton(
                    ...
                    const SizedBox(height: 25.0),
                    if (selfies.selectedFrom.isAfter(selfies.selectedTo)) ...[
                      const Text(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 2.5),
                            LogsWidget(logs: selfies.uiList[i].logs, index: i)
                          ],
                        ),
                      ),
                    ],
